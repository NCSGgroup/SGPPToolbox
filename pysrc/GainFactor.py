...
from pysrc.Setting import DecorrelatedFilterType, GaussianFilterType
...
class SingleFactor:
    ...
    def setDecFilter(self, dec):
        ...
        elif dec_type == DecorrelatedFilterType.SlideWindow:
    ...
    def setGaussianFilter(self, gauss):
        Gaussian_type = gauss[0]
        paras = gauss[1]
